...
void treEView::sortAscending()
{
	treeWidget->sortItems(0, Qt::AscendingOrder);
}
void treEView::sortDescending()
{
	treeWidget->sortItems(0, Qt::DescendingOrder);
}
void treEView::updateMenus(QTreeWidgetItem *current)
{
	insertAction->setEnabled(current != 0);
	removeAction->setEnabled(current != 0);
}
void treEView::updateSortItems()
{
